...
Shader "ASE/Block_edge"
{
	Properties
	{
		...
		[Toggle(_EDGE_GLOW_ON)] _Edge_Glow("Edge_Glow", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				#ifdef _EDGE_GLOW_ON
				float4 staticSwitch25 = _Glow_Color;
				#else
				float4 staticSwitch25 = _Face_Color;
				#endif
				float2 uv_EdgeMask = IN.ase_texcoord7.xy * _EdgeMask_ST.xy + _EdgeMask_ST.zw;
				float4 tex2DNode6 = tex2D( _EdgeMask, uv_EdgeMask );
				#ifdef _FACE_GLOW_ON
				float4 staticSwitch26 = _Glow_Color;
				#else
				float4 staticSwitch26 = _Face_Color;
				#endif
				
				float3 Albedo = ( ( staticSwitch25 * tex2DNode6 ) + ( ( 1.0 - tex2DNode6 ) * staticSwitch26 ) ).rgb;
...
/*ASEBEGIN
Version=18100
-2501.333;145.3333;2245.333;1225.667;3261.317;763.0135;1;True;True
Node;AmplifyShaderEditor.ColorNode;10;-2334.878,-90.19734;Inherit;False;Property;_Glow_Color;Glow_Color;2;1;[HDR];Create;True;0;0;False;0;False;0.244838,0.2708793,0.5943396,1;0.244838,0.2708793,0.5943396,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;14;-2286.878,-627.1973;Inherit;False;Property;_Face_Color;Face_Color;1;0;Create;True;0;0;False;0;False;0,0,0,0;0.6698113,0.2569716,0.2569716,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;6;-2573.14,-357.896;Inherit;True;Property;_EdgeMask;Edge Mask;0;0;Create;True;0;0;False;0;False;-1;b0b39bbc0e69fb846aa74393283194ac;b0b39bbc0e69fb846aa74393283194ac;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;26;-1910.24,-122.0114;Inherit;False;Property;_Face_Glow;Face_Glow;4;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;25;-1923.45,-505.2223;Inherit;False;Property;_Edge_Glow;Edge_Glow;3;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;22;-2049.655,-272.7357;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-1540.077,-151.3716;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-1578.302,-395.7109;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;15;-1029.004,-250.1672;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C56D84BFEB63C67F28232ABD46F34A8F6D9D1508